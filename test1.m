...
% Last Modified by GUIDE v2.5 08-Apr-2014 09:20:47
...
set(hObject, 'String', {'Embed in Tpvd', 'Extract in Tpvd', 'Secured Steganography','Embedd using LSB','Extract using LSB','Compress'});
...
switch popup_sel_index
    case 1
        TpvdEmbed('pro.txt','bill.jpg','x.png');
    case 2
        TpvdExtract('x.png','out.txt');
    case 3
        stego('pro.txt','x.jpg','out.txt');
    case 4
        lsbembedd('pro.txt','x.jpg');
    case 5
        labextract('hidden.jpg','out.txt');
    case 6
        haar_compression('bill.jpg',10,3);
end
